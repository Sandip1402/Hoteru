  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
        <div className="max-w-7xl w-full bg-main-color rounded-xl flex overflow-hidden shadow-xl shadow-gray-900/50">
            ...
            <div className="hidden md:flex flex-col justify-between bg-main-color w-1/2 rounded-l-xl p-3 relative">

                <div>
                    <img src="/assets/icon.png" title="logo" />
                </div>

                <div
                    className="relative flex-grow rounded-md overflow-hidden bg-gradient-to-tr from-[#5C5696] to-[#463E7E]">
